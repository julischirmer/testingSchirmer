...
@RequestTemplatePath(path = "api2/comments/_post/rq.json")
@ResponseTemplatePath(path = "api2/comments/_post/rs.json")
@SuccessfulHttpStatus(status = HttpResponseStatusType.CREATED_201)
public class PostCommentMethod extends AbstractApiMethodV2 {

    public PostCommentMethod() {
        super("api2/comments/_post/rq.json", "api2/comments/_post/rs.json", "api2/comments/comment.properties");
